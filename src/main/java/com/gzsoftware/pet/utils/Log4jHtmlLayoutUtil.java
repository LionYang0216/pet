...
/**
 * Log4j HTML Layout Util, output log4j info in html
 * @author pango leung
 *
 */
public class Log4jHtmlLayoutUtil extends HTMLLayout {
	public Log4jHtmlLayoutUtil() {
	}
	...
	public String getHeader() {
		...
		sbuf.append("<!--" + Layout.LINE_SEP);
		sbuf.append("body, table {font-family: '微软雅黑',arial,sans-serif; font-size: 10px;}" + Layout.LINE_SEP);
		sbuf.append("th {background: #364150; color: #FFFFFF; text-align: left;}" + Layout.LINE_SEP);
		sbuf.append("-->" + Layout.LINE_SEP);
		...
		sbuf.append("<th style='white-space: nowrap;'>执行时间</th>" + Layout.LINE_SEP);
